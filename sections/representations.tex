...
% TODO: Right actions and isomorphism to opposite Lie algebra
...
\begin{remark}
  ...
  If~$\glie$ is a finite dimensional Lie~algebra then the irreducible representations of~$\glie$ do not have to be finite dimensional again, and those irreducuble representations that are finite dimensional can have arbitrarily large dimension.
  
  Indeed, we will later see that the Lie~algebra~$\sllie_2(\kf)$ admits for every~$n \geq 1$ precisely one irreducible representation up to isomorphism and that~$\sllie_2(\kf)$ also admits infinite dimensional irreducible representations.
  (Although at most of countable dimension.)
  % TODO: Prove this in sl2 theory.
