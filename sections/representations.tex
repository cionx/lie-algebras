...
\begin{examples}\label{expls: representations of Lie algebras}
...
\begin{proposition}[New representations from old ones]\label{prop: new representations from old ones}
...
\begin{remark}
 For a Lie algebra $\g$ over a field $k$ the representations of $\g$ together with the homomorphisms of representations between them form a category.
\end{remark}
...
\begin{remark}\label{rem: homomorphisms of representations as invariants}
...
\begin{proposition}\label{prop: list of homomorphism of representations}
...
%TODO: Remark about non-canonical isomorphism with dual basis
