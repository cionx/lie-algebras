...
\begin{corollary}\label{cor: ideals and quotients of semisimple again semisimple}
...
\begin{corollary}\label{cor: semisimple Lie algebra identification with dual space}
