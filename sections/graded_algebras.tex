  ...
  \begin{enumerate}
    ...
    \item
      ...
      \begin{equivalenceslist}
        \item
          $f$ is an isomorphism of graded~{\algebras{$\kf$}}, i.e.\ there exists an inverse homomorphism of graded~{\algebras{$\kf$}}~$g \colon B \to A$ with~$f {} g = \id_B$ and~$g \spacing f = \id_A$.
        \item
          $f$ is bijective.
        \item
