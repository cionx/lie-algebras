...
\begin{definition}
	...
	\begin{enumerate}
		...
		\item
			A representation~$(M, \rho)$ is~\defemph{faithful}\index{faithful representation} if the homomorphism~$\rho$ is injective.
		\item
...
\begin{examples}
	...
	\begin{enumerate}
		...
		\item
			...
			\end{itemize*}
			These relations are those of the Heisenberg Lie~algebra~$\heisenberglie(n, \kf)$\index{Heisenberg Lie algebra} from \cref{examples for lie algebras}.
