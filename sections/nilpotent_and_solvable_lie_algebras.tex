...
\begin{definition}
  If~$\glie$ is a Lie~algebra then~$\glie^{(1)} = \glie^1 = [\glie, \glie]$ is the \defemph{derived Lie~algebra}\index{derived Lie algebra}\index{Lie algebra!derived} of~$\glie$.
\end{definition}
...
\begin{recall}[Triangularization and invariant flags]
  ...
  \begin{itemize}
    \item
      ...
      Every basis~$v_1, \dotsc, v_n$ of~$V$ brings with it an \defemph{associated complete flag}~$(V_i)_{i=0}^n$\index{associated flag} of~$V$ that is given by~$V_i = \gen{v_1, \dotsc, v_i}_{\kf}$ for every~$i = 0, \dotsc, n$.
