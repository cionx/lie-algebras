...
\begin{proposition}\label{prop: properties of solvable and nilpotent}
...
\begin{corollary}\label{cor: solvable via ses}
...
\begin{corollary}\label{cor: sum of solvable ideals is solvable}
...
\begin{proposition}\label{prop: common eigenvector for nilpotent Lie algebras}
...
\begin{proposition}\label{prop: stuff for Engels theorem}
...
\begin{corollary}\label{cor: ideal in nilpotent has nontrivial intersection with center}
...
\begin{theorem}[Lie]\label{thrm: Lie’s theorem}
...
\begin{proposition}\label{prop: common eigenvector for solvable Lie algebras}
...
\begin{corollary}\label{cor: irreducible representations of solvable Lie algebras are onedimenisonal}
