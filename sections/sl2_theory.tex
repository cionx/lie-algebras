...
\begin{lemma}\label{lem: e and f moving the eigenspaces}
...
\begin{example}\label{expl: natural representation of sl2}
...
\begin{theorem}[Classification of finite dimensional irreducible representations of $\sll_2(k)$]
...
\begin{theorem}\label{thrm: finite dimensional representations of sl2}
...
\begin{example}\label{expl: decomposition of the tensor product of 4 and 5}
