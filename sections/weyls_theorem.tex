...
\begin{definition}\label{defi: casimir endomorphism of a faithful representation}
...
\begin{lemma}\label{lem: decomposition of representations of semisimple Lie algebras}
