...
\begin{lem}\label{lem: associative bilinear form induces homomorphism of representations}
...
\begin{lem}[Cartan’s criterion for $\gl(V)$] \label{lem: Cartans criterion for linear Lie algebra}
