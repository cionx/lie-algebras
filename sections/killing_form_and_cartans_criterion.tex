...
\begin{lemma}\label{lem: associative bilinear form induces homomorphism of representations}
...
\begin{corollary}\label{cor: associative non-degenerate bilinear forms induce isomorphism to the dual}
...
\begin{lemma}\label{lem: orthogonal complement of an ideal is again an ideal}
...
\end{lemma}
\begin{proof}
 For every $x \in \g$, $y \in I^{\perp}$ and $z \in I$ it follows that $[x,z] \in I$ and therefore
 \[
  \beta([x,y],z)
  = -\beta([y,x],z)
  = -\beta(y,[x,z])
...
\begin{lemma}\label{lem: killing form is associative and symmetric}
...
\begin{example}\label{expl: Killing form of gl_n}
...
\begin{remark}\label{rem: associative bilinear form of a representation}
...
\begin{lemma}\label{lem: restriction of the Killing form to an ideal}
...
\begin{lemma}\label{lem: orthogonal ideals with respect to the killing form}
...
\begin{theorem}\label{thrm: concrete Jordan decomposition}
...
\begin{remark}\label{rem: concrete Jordan decomposition for matrices}
...
\begin{lemma}\label{lem: ss and nilpotent implies ad-ss and ad-nilpotent}
...
\begin{corollary}\label{cor: concrete Jordan decomposition compatible with adjoint representation}
...
\begin{lemma}\label{lem: Cartan's criterion technical lemma}
...
\begin{lemma}[Cartan’s criterion for $\gl(V)$] \label{lem: Cartans criterion for linear Lie algebra}
...
\begin{corollary}\label{cor: rad kappa is a solvable ideal}
