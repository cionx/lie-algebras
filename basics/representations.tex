...
\begin{lem}[Schur]
 ...
 \begin{enumerate}
  ...
  \item
   If $k$ is algebraically closed and $V$ an irreducible representation of $\g$ then every $\varphi \in \End_\g(V)$ is given by multiplication with some $\lambda \in k$. In particular $\End_\g(V) \cong k$ as rings.
 \end{enumerate}
\end{lem}
