...
\begin{expls}
 \begin{enumerate}[leftmargin=*]
  ...
  \item
   If $\rho \g \colon \gl(V)$ is a representation of a Lie algebra $\g$ and $\phi \colon \g' \to \g$ a homomorphism of Lie algebras then via the composition $\rho \circ \phi \colon \g' \to \gl(V)$ the vector space $V$ becomes a representation of $\g$. This corresponds to the action
   \[
